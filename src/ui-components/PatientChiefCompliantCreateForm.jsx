...
export default function PatientChiefCompliantCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setChiefComplaint(initialValues.chiefComplaint);
    setFindings(initialValues.findings);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createPatientChiefCompliant.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PatientChiefCompliantCreateForm")}
      {...rest}
    >
      <TextField
        label="Profile id"
