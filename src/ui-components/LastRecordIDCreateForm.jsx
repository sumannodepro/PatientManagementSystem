...
export default function LastRecordIDCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setLastPatientID(initialValues.lastPatientID);
    setNewPatientID(initialValues.newPatientID);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createLastRecordID.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "LastRecordIDCreateForm")}
      {...rest}
    >
      <TextField
