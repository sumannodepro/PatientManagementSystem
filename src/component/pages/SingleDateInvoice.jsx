...
import { TextField, Button, Grid, Table, TableBody, TableCell, MenuItem, FormControl, InputLabel, Select, TableContainer, TableHead, TableRow, Paper, Typography, IconButton } from '@mui/material';
    ...
    try {
      ...
      for (const treatment of invoice.treatments) {
        const treatmentData = {
          ...
          date: invoice.date,  // ✅ Use the selected date here
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={6}>
          <TextField
            ...
            value={invoice.date}  // ✅ bound to state
            onChange={(e) => handleInputChange(e, null, 'date')}  // ✅ update on change
          />
        </Grid>
      </Grid>
